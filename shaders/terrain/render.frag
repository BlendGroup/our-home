...
void main(void) {
	...
	calcPhongLightInWorld(fs_in.pos, fs_in.nor, vec3(0.0, 30.0, 0.0), cameraPos, 45.0, diffuse, specular);
	FragColor = vec4(texture(texColor, fs_in.tc).rgb * diffuse + vec3(0.1, 0.1, 0.1) * specular, 1.0);
}