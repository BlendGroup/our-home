...
public:
    ...
    {
        return Tquaternion(r + q.r, v + q.v);
    }
...
template <typename T>
static inline T dot(const Tquaternion<T>& q1, const Tquaternion<T>& q2)
{
	return dot(vec4(q1.x, q1.y, q1.z, q1.w), vec4(q2.x, q2.y, q2.z, q2.w));
}

template <typename T>
static inline Tquaternion<T> slerp(const Tquaternion<T>& x, const Tquaternion<T>& y, T a)
{
	Tquaternion<T> z = y;
...
static inline float determinant(const mat4& at) {
...
static inline mat4 inverse(const mat4& at) {
	float det = determinant(at);
	if (0.0f == det) {
		return at;
	}
	float inv_det = 1.0f / det;
	mat4 ret;
	ret[0][0] = inv_det * (+at[2][1] * at[3][2] * at[1][3] - at[3][1] * at[2][2] * at[1][3] + at[3][1] * at[1][2] * at[2][3]
			- at[1][1] * at[3][2] * at[2][3] - at[2][1] * at[1][2] * at[3][3] + at[1][1] * at[2][2] * at[3][3]);

	ret[1][0] = inv_det * (+at[3][0] * at[2][2] * at[1][3] - at[2][0] * at[3][2] * at[1][3] - at[3][0] * at[1][2] * at[2][3]
			+ at[1][0] * at[3][2] * at[2][3] + at[2][0] * at[1][2] * at[3][3] - at[1][0] * at[2][2] * at[3][3]);

	ret[2][0] = inv_det * (+at[2][0] * at[3][1] * at[1][3] - at[3][0] * at[2][1] * at[1][3] + at[3][0] * at[1][1] * at[2][3]
			- at[1][0] * at[3][1] * at[2][3] - at[2][0] * at[1][1] * at[3][3] + at[1][0] * at[2][1] * at[3][3]);

	ret[3][0] = inv_det * (+at[3][0] * at[2][1] * at[1][2] - at[2][0] * at[3][1] * at[1][2] - at[3][0] * at[1][1] * at[2][2]
			+ at[1][0] * at[3][1] * at[2][2] + at[2][0] * at[1][1] * at[3][2] - at[1][0] * at[2][1] * at[3][2]);

	ret[0][1] = inv_det * (+at[3][1] * at[2][2] * at[0][3] - at[2][1] * at[3][2] * at[0][3] - at[3][1] * at[0][2] * at[2][3]
			+ at[0][1] * at[3][2] * at[2][3] + at[2][1] * at[0][2] * at[3][3] - at[0][1] * at[2][2] * at[3][3]);

	ret[1][1] = inv_det * (+at[2][0] * at[3][2] * at[0][3] - at[3][0] * at[2][2] * at[0][3] + at[3][0] * at[0][2] * at[2][3]
			- at[0][0] * at[3][2] * at[2][3] - at[2][0] * at[0][2] * at[3][3] + at[0][0] * at[2][2] * at[3][3]);

	ret[2][1] = inv_det * (+at[3][0] * at[2][1] * at[0][3] - at[2][0] * at[3][1] * at[0][3] - at[3][0] * at[0][1] * at[2][3]
			+ at[0][0] * at[3][1] * at[2][3] + at[2][0] * at[0][1] * at[3][3] - at[0][0] * at[2][1] * at[3][3]);

	ret[3][1] = inv_det * (+at[2][0] * at[3][1] * at[0][2] - at[3][0] * at[2][1] * at[0][2] + at[3][0] * at[0][1] * at[2][2]
			- at[0][0] * at[3][1] * at[2][2] - at[2][0] * at[0][1] * at[3][2] + at[0][0] * at[2][1] * at[3][2]);

	ret[0][2] = inv_det * (+at[1][1] * at[3][2] * at[0][3] - at[3][1] * at[1][2] * at[0][3] + at[3][1] * at[0][2] * at[1][3]
			- at[0][1] * at[3][2] * at[1][3] - at[1][1] * at[0][2] * at[3][3] + at[0][1] * at[1][2] * at[3][3]);

	ret[1][2] = inv_det * (+at[3][0] * at[1][2] * at[0][3] - at[1][0] * at[3][2] * at[0][3] - at[3][0] * at[0][2] * at[1][3]
			+ at[0][0] * at[3][2] * at[1][3] + at[1][0] * at[0][2] * at[3][3] - at[0][0] * at[1][2] * at[3][3]);

	ret[2][2] = inv_det * (+at[1][0] * at[3][1] * at[0][3] - at[3][0] * at[1][1] * at[0][3] + at[3][0] * at[0][1] * at[1][3]
			- at[0][0] * at[3][1] * at[1][3] - at[1][0] * at[0][1] * at[3][3] + at[0][0] * at[1][1] * at[3][3]);

	ret[3][2] = inv_det * (+at[3][0] * at[1][1] * at[0][2] - at[1][0] * at[3][1] * at[0][2] - at[3][0] * at[0][1] * at[1][2]
			+ at[0][0] * at[3][1] * at[1][2] + at[1][0] * at[0][1] * at[3][2] - at[0][0] * at[1][1] * at[3][2]);

	ret[0][3] = inv_det * (+at[2][1] * at[1][2] * at[0][3] - at[1][1] * at[2][2] * at[0][3] - at[2][1] * at[0][2] * at[1][3]
			+ at[0][1] * at[2][2] * at[1][3] + at[1][1] * at[0][2] * at[2][3] - at[0][1] * at[1][2] * at[2][3]);

	ret[1][3] = inv_det * (+at[1][0] * at[2][2] * at[0][3] - at[2][0] * at[1][2] * at[0][3] + at[2][0] * at[0][2] * at[1][3]
			- at[0][0] * at[2][2] * at[1][3] - at[1][0] * at[0][2] * at[2][3] + at[0][0] * at[1][2] * at[2][3]);

	ret[2][3] = inv_det * (+at[2][0] * at[1][1] * at[0][3] - at[1][0] * at[2][1] * at[0][3] - at[2][0] * at[0][1] * at[1][3]
			+ at[0][0] * at[2][1] * at[1][3] + at[1][0] * at[0][1] * at[2][3] - at[0][0] * at[1][1] * at[2][3]);

	ret[3][3] = inv_det * (+at[1][0] * at[2][1] * at[0][2] - at[2][0] * at[1][1] * at[0][2] + at[2][0] * at[0][1] * at[1][2]
...
template <typename T>
static inline matNM<T,4,4> quaternionToMatrix(const Tquaternion<T>& q)
{
	matNM<T,4,4> m;
