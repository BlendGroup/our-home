...
void creditscene::init() {
	creditevents = new eventmanager({
		{FADEIN1_T, { 4.0f, 2.0f }},
		{WAIT1_T, { 6.0f, 8.0f }},
		{FADEOUT1_T, { 14.0f, 2.0f }},
		
		{FADEIN2_T, { 16.0f, 2.0f }},
		{WAIT2_T, { 18.0f, 8.0f }},
		{FADEOUT2_T, { 26.0f, 2.0f }},
		
		{FADEIN3_T, { 28.0f, 2.0f }},
		{WAIT3_T, { 30.0f, 6.0f }},
		{FADEOUT3_T, { 36.0f, 2.0f }},
		
		{FADEIN4_T, { 38.0f, 2.0f }},
		{WAIT4_T, { 40.0f, 4.0f }},
		{FADEOUT4_T, { 44.0f, 2.0f }},
		
		{FADEIN5_T, { 46.0f, 2.0f }},
		{WAIT5_T, { 48.0f, 4.0f }},
		{FADEOUT5_T, { 52.0f, 2.0f }},
		
		{FADEIN6_T, { 54.0f, 2.0f }},
		{WAIT6_T, { 56.0f, 6.0f }},
		{FADEOUT6_T, { 62.0f, 2.0f }},
		
		{FADEIN7_T, { 64.0f, 2.0f }},
		{WAIT7_T, { 66.0f, 8.0f }},
		{FADEOUT7_T, { 74.0f, 2.0f }},
	});
