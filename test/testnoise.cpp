...
void initTestNoise() {
	try {
		...
		// texture = opensimplexnoise::createNoiseTexture2D(ivec2(1024, 1024), ivec2(0, 0), 128.0f, 5, 3423);
		texture = opensimplexnoise::createFBMTexture2D(ivec2(1024, 1024), ivec2(0, 0), 256.0f, 3, 3423);
	} catch(string errorString) {
		throwErr(errorString);
	}
}
